...
Route::middleware(['auth', 'is_pimpinan'])->prefix('pimpinan')->group(function () {
    ...
    Route::get('/pesan', [PimpinanController::class, 'messages'])->name('pimpinan.pesan');
    Route::get('/pimpinan/laporan/{id}/show', [PimpinanController::class, 'viewMessage'])->name('pimpinan.viewMessage');
    Route::get('/pesan/{id}', [PimpinanController::class, 'viewMessage'])->name('pimpinan.pesan.detail');
    //Route::post('/evaluasi/{id}', [PimpinanController::class, 'evaluate'])->name('pimpinan.evaluasi');
    Route::get('/evaluasi/{id}', [PimpinanController::class, 'evaluate'])->name('pimpinan.evaluasi');
    Route::get('/pimpinan/evaluasi/{id}', [PimpinanController::class, 'showEvaluateForm'])->name('pimpinan.evaluasi');
    Route::post('/pimpinan/evaluasi/{id}', [PimpinanController::class, 'evaluate'])->name('pimpinan.submitEvaluasi');
