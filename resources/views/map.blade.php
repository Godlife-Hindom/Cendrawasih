        ...
        <div class="container">
            <div class="controls-wrapper">
                <div class="control-group">
                    ...
                    <button class="control-btn" id="showCukupBaik" data-category="Cukup Baik">
                        <span class="btn-icon">🟡</span>
                        Baik
                    </button>
    ...
    <div class="map-wrapper">
        ...
        <div class="legend-container">
            ...
            <div class="legend-content">
                ...
                <div class="legend-item" data-category="Cukup Baik">
                    <div class="legend-marker cukup-baik"></div>
    ...
    locations.forEach(loc => {
        ...
        const popupContent = `
            <div class="popup-content">
                <div class="popup-title">${loc.nama_lokasi}</div>
